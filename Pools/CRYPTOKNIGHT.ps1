...
if (($Querymode -eq "core" ) -or ($Querymode -eq "Menu")){
        ...
        $Pools +=[pscustomobject]@{"symbol"="IPBC"; "algo"="IPBC";"port"=4461;"coin"="IPBC";"location"="US";"server"="ipbc.ingest.cryptoknight.cc"; "fee"=0.0}
        $Pools +=[pscustomobject]@{"symbol"="GRFT"; "algo"="Graft";"port"=9111;"coin"="GRAFT";"location"="US";"server"="graft.ingest.cryptoknight.cc"; "fee"=0.0}
